...
silent only
silent tabonly
cd ~/Documents/Notes-for-learn-rust-with-entirely-too-many-linked-lists/basic_linked_list/src
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39 - ((13 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
